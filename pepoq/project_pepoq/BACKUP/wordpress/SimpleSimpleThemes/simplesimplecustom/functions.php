...
/**
 * head内に <title>タグを出力するコード（CHAPTER 12 - MEMO 参照）
 */
...
/**
 * titleタグを自動的に出力するコード（CHAPTER 12）
 */
//add_theme_support( 'title-tag' );


/**
 * WordPress が自動で出力する HTML に、HTML5 を使用するコード（CHAPTER 12）
 */
...
/**
 * カスタムヘッダーを背景画像として有効にするコード（CHAPTER 15）
 */
/*
$args = array(
	'width' 					=> 940,
