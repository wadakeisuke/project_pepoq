...
include('../common/header.html');
	?>
	<!--end header-->
	<div id="content" style="padding-top:70px;background-color:#FFFFE0;height:100%;">
		<div id="user_info" style="padding-top:10px;width:100%;background-:red;">
			<div style="margin:10px auto 0;width:100px; height:100px;">
