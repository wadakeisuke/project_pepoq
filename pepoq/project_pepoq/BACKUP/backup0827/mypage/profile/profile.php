		...
		<div class="user_content">
			...
			<div class="user_message">
				<div class="user_message_item">
					<p><?php echo($_SESSION['mypage']['comment']); ?><a>more</a></p>
				</div>
			</div>
			<div class="user_info_item float_left">
				<a href="edit_profile.php"><button class="btn">編集・follow</button></a>
			</div>
			

			<div style="background-color:white;" class="user_info_item float_left">
