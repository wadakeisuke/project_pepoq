...
/*.user_name{text-align:left;height:30px;width:35%;}*/
.question_num{text-align:right;height:30px;width:100%;}
    ...
    <div class="list-body js-swipeListTarget">
      <div class="list-contents list-cell">
		...
		<div class="format_question">
			...
			<div class="question_num"><small>('.$value['comment_num'].')</small></div>
		</div>
