...
echo '
					...
					<div class="question_menu">
						<ul style="text-align:center;">
							...
							<li class="question_menu_li">
								<div class="fb-like" data-href="<$mt:EntryPermalink$>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
							</li>				
							<li class="question_menu_li">
								<!--<a data-url="<$mt:EntryPermalink$>" href="https://twitter.com/share" class="twitter-share-button" data-lang="ja" data-count="vertical" data-dnt="true">ツイート</a>-->
							...
							<li class="question_menu_li">
								...
								<div class="g-plus" data-action="share" data-annotation="bubble" data-href=<$mt:EntryPermalink$>"></div>
							</li>
						</ul>
					...
					<div class="answer_to_the_question">
