	...
	<div class="question_format">
		...
		<div class="question_menu">
			<ul style="text-align:center;"><!--
				...
				<li class="question_menu_li">
					<div class="fb-like" data-href="http://pepoq.com/pepoq/single_question/single_question/single_question.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
				</li>				
				<li class="question_menu_li">
					<!--<a data-url="http://pepoq.com/pepoq/single_question/single_question/single_question.php" href="https://twitter.com/share" class="twitter-share-button" data-lang="ja" data-count="vertical" data-dnt="true">ツイート</a>-->
					<a href="https://twitter.com/share" class="twitter-share-button" data-via="PepoqQ" data-count="none">Tweet</a>
				</li>
				<li class="question_menu_li">
					<!--<div class="fb-share-button" data-href="http://pepoq.com/pepoq/single_question/single_question/single_question.php" data-layout="button_count"></div>-->
					<div class="g-plus" data-action="share" data-annotation="bubble" data-href="http://pepoq.com/pepoq/single_question/single_question/single_question.php"></div>
				</li>
			</ul>
			<ul style="text-align:center;">
				<li class="question_menu_li">
					<div class="fb-share-button" data-href="http://pepoq.com/pepoq/single_question/single_question/single_question.php" data-layout="button_count">
				</li>
				<li class="question_menu_li">
					<a href="http://pepoq.com/pepoq/single_question/single_question/single_question.php" class="hatena-bookmark-button"  data-hatena-bookmark-lang="ja" title="このエントリーをはてなブックマークに追加"><img src="https://b.st-hatena.com/images/entry-button/button-only@2x.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border:none;" /></a>
				</li>
				<li class="question_menu_li">
