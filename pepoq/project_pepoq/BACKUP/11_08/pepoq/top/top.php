...
<div id="pageall">
  ...
  <header>
      <div class="tophead">
        <div class="header_logo f_left"><p>pepoQ</p></div>
  ...
  <div class="content">
    <div class="top_rec" style="background-image:url(style/img/head.gif)">
      <div class="top_rec_box blur">
        ...
        <div class="text_fix">
          <p class="hello_p">SNS + Q&A</p>
          <i class="fa fa-tag"></i><p>「答え」が一番近くにある新感覚ソーシャルネットワークpepoQ。気になることをなんでも気軽に質問してみよう！</p>
        </div>
        </div>
        <div class="top_join">
          <p><a href="../signup/signup/signup.php">join for free</a></p>
        </div>
      </div>
      <?php
      echo '
    ...
    <div class="intro">
      <div class="text_fix">
          <p>Quality questions create a quality life. - Anthony Robbins</p>
          <p class="jap"><i class="fa fa-tag"></i>「質のいい質問が質のいい人生をつくる。　アンソニー・ロビンズ」</p>
      </div>
    </div>
    ...
    <div class="top_boxs">
      <div class="top_box">
        <div class="top_img">
          <img src="style/img/img01.jpg">
        </div>
        <div class="top_item">
          <div class="text_fix">
          <p>Personality</p>
        <p class="jap"><i class="fa fa-tag"></i>気になる人に匿名で質問してみよう。意外な一面を知ることができるかも…</p>
        </div>
        </div>
      </div>
      <div class="top_box">
        <div class="top_img">
          <img src="style/img/img02.jpg">
        </div>
        <div class="top_item">
        <div class="text_fix">
          <p>Interest
        </p>
        <p class="jap"><i class="fa fa-tag"></i>興味・関心のあることを、詳しい人に質問してみよう。あなたがした質問は自動で彼らに届きます！</p>
        </div>
        </div>
      </div>
      <div class="top_box">
        <div class="top_img">
          <img src="style/img/img03.jpg">
        </div>
        <div class="top_item">
        <div class="text_fix">
          <p>Know yourself
        </p>
        <p class="jap"><i class="fa fa-tag"></i>pepoQは定期的にあなたに質問をします。自分では気がつかない長所・短所に気づくことができる</p>
        </div>
        </div>
      </div>
    </div>
    <div class="outro">
    <div class="text_fix">
      <p>Our concept is here... 
      </p>
      <p class="jap"><i class="fa fa-tag"></i>あなただからこそ導けた「答え」をすべての人に提供する</p>
    </div>
    </div>
