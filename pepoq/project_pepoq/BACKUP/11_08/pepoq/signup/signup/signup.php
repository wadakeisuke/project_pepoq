...
<div id="pageall">
 ...
 <section>
  <!--begin header-->
  <header>
    <a href="../../top/top.php"><img src="../../img/logo.png"></a><p>新規登録</p>
  </header>
  <!--end header-->
    <!--begin content-->
    <div id="content">
      ...
      <div id="form">
        <form class="confirm_form" method="post" action="../../php/user_signup.php" novalidate name="myForm">
          <div class="c_box">
            <div class="input">
              <input class="input_style" type="text" name="nickname" ng-model="nickname" autocomplete="off" ng-init="nickname='<?php if(isset($_SESSION['signup']['last_name'])){echo($_SESSION['signup']['last_name']);} ?>'" placeholder="ニックネーム" required 　ng-minlength="1" ng-maxlength="20" class="inputing">
            </div>
            <div class="alert">
              <span class="text-danger" ng-show="myForm.nickname.$error.required">未入力</span>
              <span class="text-denger" ng-show="myForm.nickname.$error.minlength">Too short!</span>
              <span class="text-denger" ng-show="myForm.nickname.$error.maxlength">Too long!</span>
            </div>
          </div>       
          <div class="c_box fl">
            <div class="input">
          ...
          <div class="c_box fl">
            <div class="input_style">
              <input name="signup" type="submit" value="pepoQに登録する" ng-disabled="!myForm.$valid" class="submit">
            </div>
          </div>
        </form>
      </div>
      ...
      <div id="lower_content">
        <p>pepoQに登録するをクリックすることで、当サイトの<a href="../../rules/rules.html" target="_blank" >利用規約</a>及び<a href="../../rules/cookie.html" target="_blank">Cookieの使用</a>を含む<a href="../../rules/privacy.html" target="_blank">プライバシー</a>に関するポリシーに同意するものとします。</p>
      </div>
    </div>
    <!--end content-->
