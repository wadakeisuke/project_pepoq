...
$good_point_num = $question_point_num->get_good_point_num($question_id);
$bad_point_num = $question_point_num->get_bad_point_num($question_id);
...
<div class="question_box">
	<div class="question_format">
		...
		<a href="../../friend_page/profile/profile.php?friend_id='.$questioner_data[0]['id'].'">
			<div class="user_box">
				<div class="user_images f_f">
					<img src="../../mypage/profile/img/thumbnail/'.$questioner_data[0]['thumbnail'].'" style="height:60px;width:60px;">
				</div>
				<div class="user_item f_f">
					<div class="user_name">
						<p>
							'.$questioner_data[0]['name'].'
						</p>
					</div>
				</div>
			...
			<ul style="text-align:center;">
				...
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=good&question_id='.$question_id.'"><i class="fa fa-thumbs-up"></i></a>
						'.$good_point_num.'
					</div>
				...
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=bad&question_id='.$question_id.'"><i class="fa fa-thumbs-down"></i></a>
						'.$bad_point_num.'
					</div>
