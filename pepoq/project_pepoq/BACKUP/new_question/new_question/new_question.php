...
<!--
function changeform() {
    doc = document.searchbox.category;
    if (document.searchbox.genre.value == 1) {
        //必要なもの
        //要素数
    ...
    } else if (document.searchbox.category.value == 2) {
    ...
    } else if (document.searchbox.category.value == 3) {
        ...
        ?>
    } else if (document.searchbox.category.value == 4) {
        ...
        ?>
    } else if (document.searchbox.category.value == 5) {
        ...
        ?>
    } else if (document.searchbox.category.value == 6) {
        ...
        ?>
    } else if (document.searchbox.category.value == 7) {
        ...
        ?>
    } else if (document.searchbox.category.value == 8) {
        ...
        ?>
    } else if (document.searchbox.category.value == 9) {
        ...
        ?>
    } else if (document.searchbox.category.value == 10) {
        ...
        ?>
    } else if (document.searchbox.category.value == 11) {
        ...
        ?>
    } else if (document.searchbox.category.value == 12) {
        ...
        ?>
    } else if (document.searchbox.category.value == 13) {
        ...
        ?>
    } else if (document.searchbox.category.value == 14) {
        ...
        ?>
    } else if (document.searchbox.category.value == 15) {
        ...
        ?>
    } else if (document.searchbox.category.value == 16) {
        ...
        ?>
    } else if (document.searchbox.category.value == 17) {
        ...
        ?>
    } else if (document.searchbox.category.value == 18) {
        ...
        ?>
    } else if (document.searchbox.category.value == 19) {
        ...
        ?>
    } else if (document.searchbox.category.value == 20) {
        ...
        ?>
    } else if (document.searchbox.category.value == 21) {
        ...
        ?>
    } else if (document.searchbox.category.value == 22) {
        ...
        ?>
    } else if (document.searchbox.category.value == 23) {
...
<div id="page_all" style="">
    ...
    <div class="content">
        <form method="post" action="../../php/add_question.php" name="searchbox">
            ...
            <select class="select-box" name="genre" onChange="changeform()">
