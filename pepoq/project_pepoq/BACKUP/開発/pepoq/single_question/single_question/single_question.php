			...
			<ul style="text-align:center;">
				...
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=good&question_id=12"><i class="fa fa-thumbs-up"></i></a>
				...
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=bad&question_id=12"><i class="fa fa-thumbs-down"></i></a>
