...
.fb_iframe_widget_lift {bottom:-120px;left:25px;}
/*facebookのコメントが切れるので対処*/
.social_menu{width:100%;height:25px;background:;}
ul.social_menu_ul{width:100%;}
li.social_menu_li{float:left;}
</style>
<!--SNS-->
		...
		<div class="social_menu">
			<ul class="social_menu_ul">
				<li class="social_menu_li">
					<div class="fb-like" data-href="http://standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
				</li>
				<li class="social_menu_li">
					<div class="fb-share-button" data-href="http://standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>" data-layout="button_count">
				</li>
				<li class="social_menu_li">
					<div class="g-plus" data-action="share" data-annotation="bubble" data-href="http://standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>"></div>
				</li>
				<li class="social_menu_li">
		...
		<div class="question_menu">
			<ul style="text-align:center;">
				<li class="question_menu_li">
					...
					<div class="menu_format">答える</div>
				</li>
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=good&question_id=12"><i class="fa fa-thumbs-up"></i>
							<?php echo $data['question_data']['good_point']; ?>
						</a>
					</div>
				...
				<li class="question_menu_li">
					<div class="menu_format">
						<a href="../../php/question/question_point.php?point_type=bad&question_id=12"><i class="fa fa-thumbs-down"></i>
							<?php echo $data['question_data']['bad_point']; ?>
						</a>
					</div>
					<div class="menu_format">bad</div>
					</li>
				<li class="question_menu_li">
					<div class="menu_format"><i class="fa fa-comment"></i><?php echo $data['question_data']['number_of_responses']; ?></div>
...
?>
		<div class="question_box" id="ans_<?php echo $value['respondent']['id']; ?>">
			<div class="question_format">
				...
				<div class="question_text non_login_filter">
				...
				<div class="social_menu">
					<ul class="social_menu_ul">
						<li class="social_menu_li">
							<div class="fb-like" data-href="standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>#ans_<?php echo $value['respondent']['id']; ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
						</li>
						<li class="social_menu_li">
							<div class="fb-share-button" data-href="standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>#ans_<?php echo $value['respondent']['id']; ?>" data-layout="button_count">
						</li>
						<li class="social_menu_li">
							<div class="g-plus" data-action="share" data-annotation="bubble" data-href="standby.sakura.ne.jp/pepoq/single_question/single_question/single_question.php?question_id=<?php echo $question_id ?>#ans_<?php echo $value['respondent']['id']; ?>"></div>
						</li>
						<li class="social_menu_li">
							<a href="https://twitter.com/share" class="twitter-share-button" data-via="PepoqQ" data-count="none">Tweet</a>
						</li>
				...
				<div class="question_menu">
					<ul>
						<li class="s_question_menu_li">
							...
							<form name="good_point_form" method="post" action="/pepoq/php/add_answer_point.php">
								<input name="point_type" type="hidden" value="good">
								<input name="answer_id" type="hidden" value="<?php echo $value['id']; ?>">
								<a href="javascript:void(0)" onclick="document.good_point_form.submit();return false;">good</a>
							</form>
