...
.fb_iframe_widget_lift {bottom:50px;}
...
echo'
			<div class="question_box"　id="question_'.$value[0]['id'].'">
			<p>'.$value[0]['id'].'</p>
					...
					<div class="social_menu">
						<ul class="social_menu_ul">
							<li class="social_menu_li">
								<div class="fb-like" data-href="http://standby.sakura.ne.jp/wada/pepoq/mypage/timeline/index.php#question_'.$value[0]['id'].'" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
							</li>
							<li class="social_menu_li">
								<div class="fb-share-button" data-href="http://standby.sakura.ne.jp/wada/pepoq/mypage/timeline/index.php#question_'.$value[0]['id'].'" data-layout="button_count">
							</li>
							<li class="social_menu_li">
								<div class="g-plus" data-action="share" data-annotation="bubble" data-href="http://standby.sakura.ne.jp/wada/pepoq/mypage/timeline/index.php#question_'.$value[0]['id'].'"></div>
							</li>
							<li class="social_menu_li">
