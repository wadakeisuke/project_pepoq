    ...
    <div class="top_rec" style="background-image:url(style/img/head.gif)">
      <div class="top_rec_box blur">
        ...
        <div class="text_fix">
          ...
          <p>Design your relationship ！　We can create whatever we imagine
          </p>
          <p class="jap"><i class="fa fa-tag"></i>友達があなたのプロフィールを作る新しいプロフィールサイト</p>
        </div>
        </div>
        <div class="top_join">
    ...
    <div class="clear"><!--Bigin footer-->
      <div id="footer">
        <ul>
          ...
          <li><a href="../confirm/confirm.php">sign up</a></li>
          <li><a href="../rules_etc/rules.html">利用規約</a></li>
          <li><a href="../rules_etc/privacy.html">プライバシーポリシー</a></li>
          <li><a href="../rules_etc/cookie.html">Cookieについて</a></li>
          <li><a href="../rules_etc/help.html">About us</a></li>
