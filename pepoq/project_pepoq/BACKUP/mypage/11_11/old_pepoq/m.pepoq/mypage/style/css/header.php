  ...
  <header>
    <div class="tophead f_float" style="padding-top:10px;">
      <span class="logo" style="padding-left:10px;"><a href="../php/logout.php"><img src="../../img/pepoQ.png" width="80px" height="40px"></a></span>
    </div>
    <!--start sidemenu-->
                ...
                <ul class="drawer-submenu">
                  ...
                  <table>
                    <tr>
                      ...
                      <td style="padding-left:10px;"><a href="../mypage/mypage.php">mypage</a></td>
                    </tr>
                    <tr>
                      <td><i class="fa fa-eye"></i></td>
                      <td style="padding-left:10px;"><a href="../profile/profile.php">you</a></td>
                    </tr>
                    <tr>
                      <td><i class="fa fa-frown-o"></i></td>
                      <td style="padding-left:10px;"><a href="../mypage/mypage.php#friends_all">friend</a></td>
                    </tr>
                    <tr>
                      <td><i class="fa fa-question"></i></td>
                      <td style="padding-left:10px;"><a href="../question/question.php">question</a></td>
                    </tr>
