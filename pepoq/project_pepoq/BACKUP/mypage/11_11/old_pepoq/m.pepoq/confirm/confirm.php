...
<div id="pageall">
 ...
 <section>
  <!--begin header-->
  <header>
      <img src="../../img/logo.png"><p>sign up</p>
  </header>
  <!--end header-->
    <!--begin content-->
    <div id="content">
      ...
      <div id="form">
        <form class="confirm_form" method="post" action="../php/user_signup.php" novalidate name="myForm">
          ...
          <div class="c_box">
            <div class="input">
              <input class="input_style" type="text" name="lastname" ng-model="lastname" autocomplete="off" ng-init="lastname='<?php if(isset($_SESSION['signup']['last_name'])){echo($_SESSION['signup']['last_name']);} ?>'" placeholder="Last Name" required 　ng-minlength="1" ng-maxlength="20" class="inputing">
            </div>
            <div class="alert">
          ...
          <div class="c_box fl">
            <div class="input">
              <input class="input_style" type="email" name="email" ng-model="email" autocomplete="off" ng-init="email='<?php if(isset($_SESSION['signup']['signup_email'])){echo($_SESSION['signup']['signup_email']);} ?>'" placeholder="Email" required ng-minlength="5" class="inputing">
            </div>
            <div class="alert">
          ...
          <div class="c_box fl">
            <div class="input">
              <input class="input_style" type="email" name="email_cfm" ng-model="email_cfm" autocomplete="off" match="email" placeholder="Email confirm" required class="inputing">
            </div>
            <div class="alert">
          ...
          <div class="c_box fl">
            <div class="input">
              <input class="input_style" type="password" name="password" ng-model="password" ng-init="password='<?php if(isset($_SESSION['signup']['signup_password'])){echo($_SESSION['signup']['signup_password']);} ?>'" placeholder="Password" ng-minlength="6" ng-maxlength="30" required class="inputing">
            </div>
            <div class="alert">
          ...
          <div class="c_box fl">
            <div class="input_style">
              <input class="input" type="password" name="password_cfm" ng-model="password_cfm"  match="password"  placeholder="Password confirm" required class="inputing">
            </div>
            <div class="alert">
      ...
      <div id="lower_content">
        <small>popoQに登録するをクリックすることで、当サイトの<a href="../rules_etc/rules.html" target="_blank" >利用規約</a>及び<a href="../rules_etc/cookie.html" target="_blank">Cookieの使用</a>を含む<a href="../rules_etc/privacy.html" target="_blank">プライバシー</a>に関するポリシーに同意するものとします。</small>
      </div>
    </div>
    <!--end content-->
  </section>
